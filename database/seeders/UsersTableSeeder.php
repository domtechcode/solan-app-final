...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            ["id"=>"10","name"=>"Dedi Rohimat","username"=>"dedi","role"=>"Setting","current"=>"settingsln1"],
            ["id"=>"11","name"=>"Asep Ridayandi","username"=>"asep","role"=>"Setting","current"=>"settingsln2"],
            ...
            ["id"=>"55","name"=>"Verdian Ramadhan","username"=>"verdiansetting","role"=>"Setting","current"=>"settingsln3"],
