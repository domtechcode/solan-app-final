...
class CatatansTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            ["id"=>"5","user_id"=>"2","instruction_id"=>"3","catatan"=>"234234","tujuan"=>"4","kategori"=>"catatan"],
            ["id"=>"6","user_id"=>"2","instruction_id"=>"3","catatan"=>"234234","tujuan"=>"2","kategori"=>"catatan"],
            ["id"=>"7","user_id"=>"2","instruction_id"=>"3","catatan"=>"235235","tujuan"=>"5","kategori"=>"catatan"]
