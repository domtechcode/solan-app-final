...
class CreateFormQcPackingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::dropIfExists('form_qc_packings');
    }
}
