                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="side1">
                                        <ul class="sidemenu-list">
                                            ...
                                            <li><a href="{{ route('followUp.pengajuanBarangPersonal') }}" class="slide-item {{ ($title === "Pengajuan Barang Personal") ? 'active' : ''}}">Pengajuan Barang Personal</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="panel sidetab-menu">
                            ...
                            <div class="panel-body tabs-menu-body p-0 border-0">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="side1">
                                        <ul class="sidemenu-list">
                                            <li class="side-menu-label1"><a href="javascript:void(0)">Database Hitung Bahan</a></li>
                                            <li><a href="{{ route('hitungBahan.databaseHitungBahan') }}" class="slide-item {{ ($title === "Database Hitung Bahan") ? 'active' : ''}}">Database Hitung Bahan</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel-body tabs-menu-body p-0 border-0">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="side1">
                                        <ul class="sidemenu-list">
                                            <li class="side-menu-label1"><a href="javascript:void(0)">Home</a></li>
                                            <li><a href="{{ route('accounting.dashboard') }}" class="slide-item {{ ($title === "Dashboard") ? 'active' : ''}}">Dashboard</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="side1">
                                        <ul class="sidemenu-list">
                                            ...
                                            <li><a href="{{ route('admin.dataLangkahKerja') }}" class="slide-item {{ ($title === "Data Langkah Kerja") ? 'active' : ''}}">Data Langkah Kerja</a></li>
                                            <li><a href="{{ route('admin.dataMachine') }}" class="slide-item {{ ($title === "Data Machine") ? 'active' : ''}}">Data Machine</a></li>
                                            <li><a href="{{ route('admin.dataDriver') }}" class="slide-item {{ ($title === "Data Driver") ? 'active' : ''}}">Data Driver</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
