                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input type="text" wire:model="dataRab.{{ $key }}.real" class="form-control" autocomplete="off" placeholder="REAL" type-currency="IDR">
                                                    </div>
...
@push('scripts')
    <script>
        // Fungsi untuk menambahkan event listener pada input dengan atribut type-currency="IDR"
