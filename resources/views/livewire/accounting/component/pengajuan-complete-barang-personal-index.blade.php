<div>
    ...
    <div class="row">
        <div class="col">
            <select id="" name="" class="form-control form-select w-auto" wire:model="paginatePengajuanCompleteBarangPersonal">
        ...
        <div class="col d-flex justify-content-end">
            <input type="text" class="form-control w-auto" placeholder="Search" wire:model="searchPengajuanCompleteBarangPersonal">
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table border text-nowrap text-md-nowrap table-bordered table-hover mb-0">
                    ...
                    <tbody>
                        @forelse ($pengajuanCompleteBarangPersonal as $key => $itemPengajuanBarangSpk)
                            <tr>
                                <td>{{ $key + 1 }}</td>
                                <td>
                                ...
                                <td>
                                    <div class="btn-list">
                                        <button class="btn btn-icon btn-sm btn-dark" data-bs-toggle="modal"
                                            data-bs-target="#modalPengajuanCompleteBarangPersonal"
                                            wire:click="modalPengajuanCompleteBarangPersonal({{ $itemPengajuanBarangSpk->id }})"
                                            wire:key="modalPengajuanCompleteBarangPersonal({{ $itemPengajuanBarangSpk->id }})"><i
        ...
        <div class="col d-flex justify-content-end mt-3">
            {{ $pengajuanCompleteBarangPersonal->links() }}
        </div>
    </div>

    <!-- Modal General-->
    <div wire:ignore.self class="modal fade" id="modalPengajuanCompleteBarangPersonal" tabindex="-1" role="dialog">
