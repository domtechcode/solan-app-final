<div>
    ...
    <div class="row">
        <div class="col">
            <select id="" name="" class="form-control form-select w-auto" wire:model="paginateLateSchedule">
        ...
        <div class="col d-flex justify-content-end">
            <input type="text" class="form-control w-auto" placeholder="Search" wire:model="searchLateSchedule">
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table border text-nowrap text-md-nowrap table-bordered table-hover mb-0">
                    ...
                    <tbody>
                        @forelse ($instructionsLateSchedule as $key => $dataInstruction)
                                ...
                                <td>
                                    ...
                                    @if ($dataInstruction->instruction->group_id)
                                        <button class="btn btn-icon btn-sm btn-info" data-bs-toggle="modal"
                                            data-bs-target="#openModalGroupLateSchedule"
                                            wire:click="modalInstructionDetailsGroupLateSchedule({{ $dataInstruction->instruction->group_id }})"
                                            wire:key="modalInstructionDetailsGroupLateSchedule({{ $dataInstruction->instruction->group_id }})">Group-{{ $dataInstruction->instruction->group_id }}</button>
                                    @endif
                                </td>
                                ...
                                <td>
                                    <div class="btn-list">
                                        <button class="btn btn-icon btn-sm btn-dark" data-bs-toggle="modal"
                                            data-bs-target="#openModalLateSchedule"
                                            wire:click="modalInstructionDetailsLateSchedule({{ $dataInstruction->instruction->id }})"
                                            wire:key="modalInstructionDetailsLateSchedule({{ $dataInstruction->instruction->id }})"><i
        ...
        <div class="col d-flex justify-content-end mt-3">
            {{ $instructionsLateSchedule->links() }}
        </div>
    </div>


    <!-- Modal General-->
    <div wire:ignore.self class="modal fade" id="openModalLateSchedule" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-fullscreen modal-dialog-scrollable" role="document">
            <div class="modal-content">
                                                            ...
                                                            <div wire:ignore>
                                                                <div class="form-group">
                                                                    <select style="width: 100%;"
                                                                        ...
                                                                        data-parent="#openModalLateSchedule"
                ...
                <div class="modal-footer">
                    <button class="btn btn-success" wire:click="reschedulelateschedule" wire:key="reschedulelateschedule">Reschedule</button>
    ...
    <!-- Modal Group-->
    <div wire:ignore.self class="modal fade" id="openModalGroupLateSchedule" tabindex="-1" role="dialog">
...
@push('scripts')
    <script>
        window.addEventListener('close-modal-late-schedule', event => {
            $('#openModalLateSchedule').modal('hide');
        });
    </script>
@endpush
