<div>
    ...
    <div class="row">
        <div class="row mb-3">
            <div class="col">
                <select id="" name="" class="form-control form-select w-auto" wire:model="paginatePond">
            ...
            <div class="col d-flex justify-content-end">
                <input type="text" class="form-control w-auto" placeholder="Search" wire:model="searchPond">
            </div>
        </div>

        <div class="row">
            @foreach ($instructionsByUserPond as $user => $instructions)
                <div class="col-lg-6">
                    <div class="expanel">
                                                        ...
                                                        <td>
                                                            ...
                                                            @if ($dataInstruction->instruction->group_id)
                                                                <button class="btn btn-icon btn-sm btn-info"
                                                                    ...
                                                                    data-bs-target="#openModalGroupPond"
                                                                    wire:click="modalInstructionDetailsGroupPond({{ $dataInstruction->instruction->group_id }})"
                                                                    wire:key="modalInstructionDetailsGroupPond({{ $dataInstruction->instruction->group_id }})">Group-{{ $dataInstruction->instruction->group_id }}</button>
                                                            @endif
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="btn-list">
                                                                <button class="btn btn-icon btn-sm btn-dark"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#openModalPond"
                                                                    wire:click="modalInstructionDetailsPond({{ $dataInstruction->instruction->id }})"
                                                                    wire:key="modalInstructionDetailsPond({{ $dataInstruction->instruction->id }})"><i
    ...
    <!-- Modal General-->
    <div wire:ignore.self class="modal fade" id="openModalPond" tabindex="-1" role="dialog">
    ...
    <!-- Modal Group-->
    <div wire:ignore.self class="modal fade" id="openModalGroupPond" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
