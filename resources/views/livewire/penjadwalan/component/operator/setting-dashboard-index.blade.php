                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="panel-group1" id="accordion1">
                                @foreach($instructionsByUser as $user => $instructions)
                                <div class="panel panel-default">
                                    <div class="panel-heading1">
                                        <h4 class="panel-title1">
                                            <a class="accordion-toggle collapsed" data-bs-toggle="collapse" data-bs-parent="#accordion" href="#collapse{{ $loop->index + 1 }}" aria-expanded="false">{{ $user }}</a>
                                        </h4>
                                    </div>
                                    <div id="collapse{{ $loop->index + 1 }}" class="panel-collapse collapse" role="tabpanel" aria-expanded="false">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            @if($dataInstruction->instruction->group_id)
                                                                                <button class="btn btn-icon btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#openModalGroupSetting" wire:click="modalInstructionDetailsGroupSetting({{ $dataInstruction->instruction->group_id }})" wire:key="modalInstructionDetailsGroupSetting({{ $dataInstruction->instruction->group_id }})">Group-{{ $dataInstruction->instruction->group_id }}</button>
                                                                            @endif
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <div class="btn-list">         
                                                                                <button class="btn btn-icon btn-sm btn-dark" data-bs-toggle="modal" data-bs-target="#openModalSetting" wire:click="modalInstructionDetailsSetting({{ $dataInstruction->instruction->id }})" wire:key="modalInstructionDetailsSetting({{ $dataInstruction->instruction->id }})"><i class="fe fe-eye"></i></button>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                @empty
