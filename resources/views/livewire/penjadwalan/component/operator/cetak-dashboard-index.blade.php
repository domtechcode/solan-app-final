<div>
    ...
    <div class="row">
        <div class="row mb-3">
            <div class="col">
                <select id="" name="" class="form-control form-select w-auto" wire:model="paginateCetak">
            ...
            <div class="col d-flex justify-content-end">
                <input type="text" class="form-control w-auto" placeholder="Search" wire:model="searchCetak">
            </div>
        </div>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if ($dataInstruction->instruction->group_id)
                                                                <button class="btn btn-icon btn-sm btn-info"
                                                                    ...
                                                                    data-bs-target="#openModalGroupCetak"
                                                                    wire:click="modalInstructionDetailsGroupCetak({{ $dataInstruction->instruction->group_id }})"
                                                                    wire:key="modalInstructionDetailsGroupCetak({{ $dataInstruction->instruction->group_id }})">Group-{{ $dataInstruction->instruction->group_id }}</button>
                                                            @endif
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="btn-list">
                                                                <button class="btn btn-icon btn-sm btn-dark"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#openModalCetak"
                                                                    wire:click="modalInstructionDetailsCetak({{ $dataInstruction->instruction->id }})"
                                                                    wire:key="modalInstructionDetailsCetak({{ $dataInstruction->instruction->id }})"><i
    ...
    <!-- Modal General-->
    <div wire:ignore.self class="modal fade" id="openModalCetak" tabindex="-1" role="dialog">
    ...
    <!-- Modal Group-->
    <div wire:ignore.self class="modal fade" id="openModalGroupCetak" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
