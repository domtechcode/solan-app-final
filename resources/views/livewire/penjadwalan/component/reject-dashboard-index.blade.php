<div>
    ...
    <div class="row">
        <div class="col">
                <select id="" name="" class="form-control form-select w-auto" wire:model="paginateReject">
        ...
        <div class="col d-flex justify-content-end">
            <input type="text" class="form-control w-auto" placeholder="Search" wire:model="searchReject">
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-md-12">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($dataInstruction->instruction->group_id)
                                        <button class="btn btn-icon btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#openModalGroupReject" wire:click="modalInstructionDetailsGroupReject({{ $dataInstruction->instruction->group_id }})">Group-{{ $dataInstruction->instruction->group_id }}</button>
                                    @endif
                                </td>
                                ...
                                <td>
                                    <div class="btn-list">         
                                        <button class="btn btn-icon btn-sm btn-dark" data-bs-toggle="modal" data-bs-target="#openModalReject" wire:click="modalInstructionDetailsReject({{ $dataInstruction->instruction->id }})"><i class="fe fe-eye"></i></button>
                                    </div>
                                </td>
                            </tr>
                        @empty
        ...
        <div class="col d-flex justify-content-end mt-3">
            {{ $instructionsReject->links() }}
        </div>
    </div>
    

    <!-- Modal General-->
    <div wire:ignore.self class="modal fade" id="openModalReject" tabindex="-1" role="dialog">
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div wire:ignore>
                                                                <div class="form-group">
                                                                    <select style="width: 100%;" class="form-control work_step_list_id-{{ $key }}" data-clear data-pharaonic="select2" data-parent="#openModalReject" data-component-id="{{ $this->id }}" data-placeholder="Select Langkah Kerja" wire:model.defer="workSteps.{{ $key }}.work_step_list_id" id="work_step_list_id-{{ $key }}" required>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div wire:ignore>
                                                                <div class="form-group">
                                                                    <select style="width: 100%;" class="form-control user_id" data-clear data-pharaonic="select2" data-parent="#openModalReject" data-component-id="{{ $this->id }}" data-placeholder="Select User" wire:model.defer="workSteps.{{ $key }}.user_id" id="user_id-{{ $key }}" required>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div wire:ignore>
                                                                <div class="form-group">
                                                                    <select style="width: 100%;" class="form-control machine_id" data-clear data-pharaonic="select2" data-parent="#openModalReject" data-component-id="{{ $this->id }}" data-placeholder="Select Machine" wire:model.defer="workSteps.{{ $key }}.machine_id" id="machine_id-{{ $key }}">
    ...
    <!-- Modal Group-->
    <div wire:ignore.self class="modal fade" id="openModalGroupReject" tabindex="-1" role="dialog">
