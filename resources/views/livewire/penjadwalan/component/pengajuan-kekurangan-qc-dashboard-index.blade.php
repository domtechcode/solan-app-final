<div>
    ...
    <div class="row">
        <div class="col">
            <select id="" name="" class="form-control form-select w-auto" wire:model="paginatePengajuanKekuranganQc">
        ...
        <div class="col d-flex justify-content-end">
            <input type="text" class="form-control w-auto" placeholder="Search" wire:model="searchPengajuanKekuranganQc">
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-md-12">
                    ...
                    <tbody>
                        @forelse ($instructionsPengajuanKekuranganQc as $key => $dataInstruction)
                            <tr wire:key="{{ $dataInstruction->instruction->id }}">
                                ...
                                <td>
                                    <span
                                        class="badge bg-primary rounded-pill text-white p-2 px-3">{{ $dataInstruction->status }}</span>
                                </td>
                                <td>
                                    <div class="btn-list">
                                        ...
                                        <button class="btn btn-icon btn-sm btn-success"
                                            wire:click="pengajuanKekuranganQc({{ $dataInstruction->id }}, 'Approved')"
                                            wire:key="pengajuanKekuranganQc({{ $dataInstruction->id }}, 'Approved')">Approved</button>
                                        <button class="btn btn-icon btn-sm btn-primary"
                                            wire:click="pengajuanKekuranganQc({{ $dataInstruction->id }}, 'Reject')"
                                            wire:key="pengajuanKekuranganQc({{ $dataInstruction->id }}, 'Reject')">Reject</button>
                                    </div>
                                </td>
                            </tr>
                        @empty
