                                ...
                                <td>
                                    <div class="btn-list">
                                        <button class="btn btn-icon btn-sm btn-dark" data-bs-toggle="modal"
                                            data-bs-target="#openModalDijadwalkan"
                                            wire:click="modalInstructionDetailsDijadwalkan({{ $dataInstruction->instruction->id }})"
                                            wire:key="modalInstructionDetailsDijadwalkan({{ $dataInstruction->instruction->id }})"><i
