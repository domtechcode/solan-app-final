                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($dataInstruction->instruction->group_id)
                                        ...
                                        data-bs-target="#openModalGroupIncoming" wire:click="modalInstructionDetailsGroupIncoming({{ $dataInstruction->instruction->group_id }})" wire:key="modalInstructionDetailsGroupIncoming({{ $dataInstruction->instruction->group_id }})">Group-{{ $dataInstruction->instruction->group_id }}</button>
                                    @endif
                                </td>
                                ...
                                <td>
                                    <div class="btn-list">         
                                        ...
                                        data-bs-target="#openModalIncoming" wire:click="modalInstructionDetailsIncoming({{ $dataInstruction->instruction->id }})" wire:key="modalInstructionDetailsIncoming({{ $dataInstruction->instruction->id }})"><i class="fe fe-eye"></i></button>
                                    </div>
                                </td>
                            </tr>
                        @empty
