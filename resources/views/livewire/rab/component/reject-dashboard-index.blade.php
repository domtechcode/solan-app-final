<div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($dataInstruction->instruction->group_id)
                                        <button class="btn btn-icon btn-sm btn-info" wire:click="modalInstructionDetailsGroupReject({{ $dataInstruction->instruction->group_id }})">Group-{{ $dataInstruction->instruction->group_id }}</button>
                                    @endif
                                </td>
    ...
    <!-- Modal General-->
    <div wire:ignore.self class="modal fade" id="detailInstructionModalReject" tabindex="-1" role="dialog">
    ...
    <!-- Modal Group-->
    <div wire:ignore.self class="modal fade" id="detailInstructionModalGroupReject" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
...
@push('scripts')
    <script>
        window.addEventListener('close-modal-reject', event =>{
            $('#detailInstructionModalReject').modal('hide');
            $('#detailInstructionModalGroupReject').modal('hide');
        });

        window.addEventListener('show-detail-instruction-modal-reject', event =>{
            $('#detailInstructionModalReject').modal('show');
        });

        window.addEventListener('show-detail-instruction-modal-group-reject', event =>{
            $('#detailInstructionModalGroupReject').modal('show');
        });
    </script>
@endpush