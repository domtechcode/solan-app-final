        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title">Form Edit RAB</h3>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($rabItems as $index => $rabItem)
                                            <tr>
                                                <td>
                                                    <div class="form-group">
                                                        <select wire:model="rabItems.{{ $index }}.jenisPengeluaran"
                                                            class="form-control form-select" data-bs-placeholder="Pilih Jenis Pengeluaran">
                                                            <option label="-- Pilih Jenis Pengeluaran --"></option>
                                                            <option value="Bahan Baku">Bahan Baku</option>
                                                            <option value="Plate">Plate</option>
                                                            <option value="Film">Film</option>
                                                            <option value="UV/WB/Laminating">UV/WB/Laminating</option>
                                                            ...
                                                            <option value="Matress Foil/Emboss">Matress Foil/Emboss</option>
                                                            <option value="Mata Itik + Pasang">Mata Itik + Pasang</option>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-danger"
                                                        wire:click="removeRAB({{ $index }})"><i class="fe fe-trash-2"></i></button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
