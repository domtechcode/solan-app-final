                                ...
                                <td>
                                    <div class="btn-list">
                                        <button class="btn btn-icon btn-sm btn-dark" data-bs-toggle="modal"
                                            data-bs-target="#modalPengajuanBarangSpk"
                                            wire:key="modalPengajuanBarangSpk({{ $itemPengajuanBarangSpk->id }}, {{ $itemPengajuanBarangSpk->instruction_id }})"
                                            wire:click="modalPengajuanBarangSpk({{ $itemPengajuanBarangSpk->id }}, {{ $itemPengajuanBarangSpk->instruction_id }})"><i
                    ...
                    <div class="row mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" wire:model="harga_satuan" id="harga_satuan"
                                        class="form-control" autocomplete="off" placeholder="Harga Satuan"
                                        type-currency="IDR">
                                </div>
                                @error('harga_satuan')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" wire:model="qty_purchase" id="qty_purchase"
                                        class="form-control" autocomplete="off" placeholder="Qty Purchase"
                                        type-currency="IDR">
                                </div>
                                @error('qty_purchase')
                                    <div><span class="text-danger">{{ $message }}</span></div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" wire:model="stock" id="stock" class="form-control"
                                        autocomplete="off" placeholder="Stock" type-currency="IDR">
                                </div>
                                @error('stock')
                                    <div><span class="text-danger">{{ $message }}</span></div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" wire:model="total_harga" id="total_harga"
                                        class="form-control" autocomplete="off" placeholder="Total Harga Barang"
                                        readonly>
                                    <button class="btn btn-primary" type="button" wire:click="cekTotalHarga()">Cek
                                        Total</button>
                                </div>
                                @error('total_harga')
                                    <div><span class="text-danger">{{ $message }}</span></div>
                ...
                <div class="modal-footer">
                    @if (isset($dataBarang))
                        <button class="btn btn-success"
                            wire:click="approveBarang({{ $dataBarang->id }})">Approve</button>
                        <button class="btn btn-primary"
                            wire:click="rejectBarang({{ $dataBarang->id }})">Reject</button>
                    @endif
                </div>
            </div>
        </div>
