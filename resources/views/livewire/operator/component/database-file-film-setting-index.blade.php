        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title">Database File Film Setting</h3>
                </div>
                <div class="card-body">
                    <!-- ROW-2 END -->
                    <div class="row">
                                    ...
                                    <tbody>
                                        @forelse ($instructionsNewSpk as $key => $dataInstruction)
                                            <tr wire:key="{{ $dataInstruction->id }}">
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ $dataInstruction->file_name }}</td>
                                                <td>
                                                ...
                                                <td>{{ $dataInstruction->instruction->spk_type }}
                                                    @if ($dataInstruction->instruction->spk_type !== 'production' && $dataInstruction->instruction->count !== null)
                                                        - <span
                                                            class="tag tag-border">{{ $dataInstruction->instruction->count }}</span>
                                                    @endif
                                                </td>
                                                ...
                                                <td>{{ $dataInstruction->keperluan }}</td>
                                                <td>{{ $dataInstruction->ukuran_film }}</td>
                                                <td>{{ $dataInstruction->jumlah_film }}</td>

                                                <td>
                                                    <div class="btn-list">
                                                        <button class="btn btn-icon btn-sm btn-dark"
                                                            data-bs-toggle="modal" data-bs-target="#openModalNewSpk"
                                                            wire:click="modalInstructionDetailsNewSpk({{ $dataInstruction->instruction->id }})"><i
                                                                class="fe fe-eye"></i></button>
                                                        <a class="btn btn-icon btn-sm btn-info"
                                                            href="{{ asset(Storage::url($dataInstruction->file_path . '/' . $dataInstruction->file_name)) }}"
                                                            download><i class="fe fe-download"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @empty
