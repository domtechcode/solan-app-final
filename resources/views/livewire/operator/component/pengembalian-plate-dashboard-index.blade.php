<div>
    ...
    <div class="row">
        <div class="col">
            <select id="" name="" class="form-control form-select w-auto" wire:model="paginatePengembalianPlate">
        ...
        <div class="col d-flex justify-content-end">
            <input type="text" class="form-control w-auto" placeholder="Search" wire:model="searchPengembalianPlate">
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table border text-nowrap text-md-nowrap table-bordered table-hover mb-0">
                    ...
                    <tbody>
                        @forelse ($instructionsPengembalianPlate as $key => $dataInstruction)
                                ...
                                <td>
                                    ...
                                    @if ($dataInstruction->instruction->group_id)
                                        <button class="btn btn-icon btn-sm btn-info" data-bs-toggle="modal"
                                            data-bs-target="#detailInstructionModalGroupPengembalianPlate"
                                            wire:click="modalInstructionDetailsGroupPengembalianPlate({{ $dataInstruction->instruction->group_id }})"
                                            wire:key="modalInstructionDetailsGroupPengembalianPlate({{ $dataInstruction->instruction->group_id }})">Group-{{ $dataInstruction->instruction->group_id }}</button>
                                    @endif
                                </td>
                                ...
                                <td>
                                    <div class="btn-list">
                                        <button class="btn btn-icon btn-sm btn-dark" data-bs-toggle="modal"
                                            data-bs-target="#detailInstructionModalPengembalianPlate"
                                            wire:click="modalInstructionDetailsPengembalianPlate({{ $dataInstruction->instruction->id }})"
                                            wire:key="modalInstructionDetailsPengembalianPlate({{ $dataInstruction->instruction->id }})"><i
                                                class="fe fe-eye"></i></button>
                                        <button class="btn btn-icon btn-sm btn-success" 
                                            wire:click="kondisiPengembalianPlate({{ $dataInstruction->id }}, 'Bagus')"
                                            wire:key="kondisiPengembalianPlate({{ $dataInstruction->id }}, 'Bagus')">Bagus</button>
                                        <button class="btn btn-icon btn-sm btn-primary" 
                                            wire:click="kondisiPengembalianPlate({{ $dataInstruction->id }}, 'Rusak')"
                                            wire:key="kondisiPengembalianPlate({{ $dataInstruction->id }}, 'Rusak')">Rusak</button>
                                    </div>
                                </td>
                            </tr>
                        @empty
        ...
        <div class="col d-flex justify-content-end mt-3">
            {{ $instructionsPengembalianPlate->links() }}
        </div>
    </div>


    <!-- Modal General-->
    <div wire:ignore.self class="modal fade" id="detailInstructionModalPengembalianPlate" tabindex="-1" role="dialog">
    ...
    <!-- Modal Group-->
    <div wire:ignore.self class="modal fade" id="detailInstructionModalGroupPengembalianPlate" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
