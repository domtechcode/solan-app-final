<div>
                                ...
                                <td>
                                    ...
                                    @if ($dataInstruction->instruction->group_id)
                                        <button class="btn btn-icon btn-sm btn-info"
                                            wire:click="modalInstructionDetailsGroupCompleteCustomerChecker({{ $dataInstruction->instruction->group_id }})">Group-{{ $dataInstruction->instruction->group_id }}</button>
                                    @endif
                                </td>
                                    ...
                                    <div class="btn-list">
                                        @if ($dataInstruction->instruction->spk_type == 'layout')
                                            <button class="btn btn-icon btn-sm btn-primary"
                                                wire:click="modalInstructionDetailsRevisiLayoutAcc({{ $dataInstruction->instruction->id }})"><i
                                                    class="fe fe-eye"></i></button>
                                        @else
                                            <button class="btn btn-icon btn-sm btn-dark"
                                                wire:click="modalInstructionDetailsCompleteCustomerChecker({{ $dataInstruction->instruction->id }})"><i
                                                    class="fe fe-eye"></i></button>
                                        @endif
    ...
    <!-- Modal General-->
    <div wire:ignore.self class="modal fade" id="detailInstructionModalRevisiLayoutAcc" tabindex="-1" role="dialog">
                            ...
                            <div class="expanel expanel-default">
                                <div class="expanel-body">
                                    ...
                                    <div class="input-group control-group" style="padding-top: 5px;">
                                        <textarea class="form-control mb-4" placeholder="Alasan Revisi Layout" rows="4" wire:model="alasan_revisi"></textarea>
                                    </div>
                                    @error('alasan_revisi')
    ...
    <!-- Modal General-->
    <div wire:ignore.self class="modal fade" id="detailInstructionModalCompleteCustomerChecker" tabindex="-1"
        role="dialog">
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Modal Group-->
    <div wire:ignore.self class="modal fade" id="detailInstructionModalGroupCompleteCustomerChecker" tabindex="-1"
        role="dialog">
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
...
@push('scripts')
    <script>
        window.addEventListener('close-modal-complete-checker-acc', event => {
            $('#detailInstructionModalCompleteCustomerChecker').modal('hide');
            $('#detailInstructionModalRevisiLayoutAcc').modal('hide');
            $('#detailInstructionModalGroupCompleteCustomerChecker').modal('hide');
        });

        window.addEventListener('show-detail-instruction-modal-complete-customer-checker', event => {
            $('#detailInstructionModalCompleteCustomerChecker').modal('show');
        });

        window.addEventListener('show-detail-instruction-modal-revisi-layout-acc', event => {
            $('#detailInstructionModalRevisiLayoutAcc').modal('show');
        });

        window.addEventListener('show-detail-instruction-modal-group-complete-customer-checker', event => {
            $('#detailInstructionModalGroupCompleteCustomerChecker').modal('show');
        });
    </script>
@endpush
