<div>
                                ...
                                <td>
                                    ...
                                    @if ($dataInstruction->instruction->group_id)
                                        <button class="btn btn-icon btn-sm btn-info"
                                            wire:click="modalInstructionDetailsGroupCompleteChecker({{ $dataInstruction->instruction->group_id }})">Group-{{ $dataInstruction->instruction->group_id }}</button>
                                    @endif
                                </td>
                                    ...
                                    <div class="btn-list">
                                        @if ($dataInstruction->instruction->spk_type == 'layout')
                                            <button class="btn btn-icon btn-sm btn-primary"
                                                wire:click="modalInstructionDetailsRevisiLayout({{ $dataInstruction->instruction->id }})"><i
                                                    class="fe fe-eye"></i></button>
                                        @else
                                            <button class="btn btn-icon btn-sm btn-dark"
                                                wire:click="modalInstructionDetailsCompleteChecker({{ $dataInstruction->instruction->id }})"><i
                                                    class="fe fe-eye"></i></button>
                                        @endif
                                    </div>
                                </td>
    ...
    <!-- Modal Group-->
    <div wire:ignore.self class="modal fade" id="detailInstructionModalGroupCompleteChecker" tabindex="-1"
        role="dialog">
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
