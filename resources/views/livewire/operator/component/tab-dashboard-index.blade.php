                ...
                <div class=" tab-menu-heading">
                    <div class="tabs-menu1">
                        ...
                        <ul class="nav panel-tabs">
                            ...
                            @if (Auth()->user()->jobdesk == 'Plate')
                                <li>
                                    <button href="#tab7"
                                        class="{{ $activeTab === 'tab7' ? 'active' : '' }} btn btn-primary mt-1 mb-1 me-3"
                                        data-bs-toggle="tab" wire:click="changeTab('tab7')" wire:key="tab7">Plate
                                        - {{ $dataCountTotalPlate }}
                                    </button>
                                </li>
                            @endif
                                ...
                                <div class="card card-headpills">
                                    ...
                                    <div class="card-header border-bottom">
                                        <ul class="nav nav-pills card-header-pills">
                                            <li class="nav-item">
                                                <button
                                                    class="btn btn-info mt-1 mb-1 me-3 {{ $activeTabPlate === 'tabPlate1' ? 'active' : '' }}"
                                                    data-bs-toggle="tab" wire:click="changeTabPlate('tabPlate1')"
                                                    wire:key="tabPlate1" href="#tabPlate1">Pengembalian Plate -
                                                    {{ $dataCountPengembalianPlate }}</button>
                                            </li>
                                            <li class="nav-item">
                                                <button
