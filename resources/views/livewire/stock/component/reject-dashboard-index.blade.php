<div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-list">         
                                        ...
                                        <button class="btn btn-icon btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#openModalRejectStock" wire:click="modalInstructionStockReject({{ $dataInstruction->instruction->id }})"><i class="fe fe-edit"></i></button>
                                    </div>
                                </td>
                            </tr>
                        @empty
    ...
    <!-- Modal General-->
    <div wire:ignore.self class="modal fade" id="openModalRejectStock" tabindex="-1" role="dialog">
...
@push('scripts')
    <script>
        window.addEventListener('close-modal-reject', event =>{
            $('#openModalRejectStock').modal('hide');
        });
    </script>
@endpush