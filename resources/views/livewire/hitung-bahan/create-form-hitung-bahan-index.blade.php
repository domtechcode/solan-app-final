            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="canvas-wrapper-{{ $index }}"></div>
                        <div class="row mt-3">
                          <div class="col-lg-12">
                              <div class="text-wrap">
                                  <div class="example">
                                      ...
                                      <div class="form-row">
                                          <div class="col-sm-6 col-md-6">
                                              <div class="form-group">
                                                  ...
                                                  <div class="row">
                                                      <div class="col-sm">
                                                        <input type="text" autocomplete="off" class="form-control" placeholder="Panjang" wire:model="layoutSettings.{{ $index }}.panjang_barang_jadi">
                                                      </div>
                                                      <div class="col-sm-1">
                                                        <label class="form-label text-center">X</label>
                                                      </div>
                                                      <div class="col-sm">
                                                        <input type="text" autocomplete="off" class="form-control" placeholder="Lebar" wire:model="layoutSettings.{{ $index }}.lebar_barang_jadi">
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                                          <div class="col-sm-6 col-md-6">
                                              <div class="form-group">
                                                  ...
                                                  <div class="row">
                                                      <div class="col-sm">
                                                        <input type="text" autocomplete="off" class="form-control" placeholder="Panjang" wire:model="layoutSettings.{{ $index }}.panjang_bahan_cetak">
                                                      </div>
                                                      <div class="col-sm-1">
                                                          <label class="form-label text-center">X</label>
                                                      </div>
                                                      <div class="col-sm">
                                                        <input type="text" autocomplete="off" class="form-control" placeholder="Lebar" wire:model="layoutSettings.{{ $index }}.lebar_bahan_cetak">
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-options">
                                <div class="btn-list">
                                    ...
                                    <button type="button" class="btn btn-sm btn-success"
                                        wire:click="addFormKeterangan({{ $index }})"><i class="fe fe-plus"></i>
                                        ...
                                        <div class="form-row">
                                            <div class="col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm">
                                                          <input type="text" autocomplete="off" class="form-control" placeholder="Panjang" wire:model="keterangans.{{ $index }}.{{ $keteranganIndex }}.panjang">
                                                        </div>
                                                        <div class="col-sm-1">
                                                          <label class="form-label text-center">X</label>
                                                        </div>
                                                        <div class="col-sm">
                                                          <input type="text" autocomplete="off" class="form-control" placeholder="Lebar" wire:model="keterangans.{{ $index }}.{{ $keteranganIndex }}.lebar">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="example">
                                  <div class="row">
                                    ...
                                    <div class="col d-flex justify-content-end">
                                      <button class="btn btn-sm btn-success" wire:click="addRincianPlate({{ $index }}, {{ $keteranganIndex }})">Add Rincian Plate</button>
                                    </div>
                                </div>
                                <hr>
                                      ...
                                      <tbody>
                                        @foreach ($keterangan['rincianPlate'] ?? [] as $rincianIndex => $rincian)
                                          <tr>
                                              <td>
                                                  <div class="form-group">
                                                      <select wire:model="keterangans.{{ $index }}.{{ $keteranganIndex }}.rincianPlate.{{ $rincianIndex }}.state" class="form-control form-select" data-bs-placeholder="Pilih View">
                                              ...
                                              <td>
                                                  <div class="form-group">
                                                      <input type="text" autocomplete="off" class="form-control" placeholder="Plate" wire:model="keterangans.{{ $index }}.{{ $keteranganIndex }}.rincianPlate.{{ $rincianIndex }}.plate">
                                                  </div>
                                              </td>
                                              <td>
                                                  <div class="form-group">
                                                    <input type="text" autocomplete="off" class="form-control" placeholder="Jumlah Lembar Cetak" wire:model="keterangans.{{ $index }}.{{ $keteranganIndex }}.rincianPlate.{{ $rincianIndex }}.jumlah_lembar_cetak">
                                                  </div>
                                              </td>
                                              <td>
                                                  <div class="form-group">
                                                    <input type="text" autocomplete="off" class="form-control" placeholder="Waste" wire:model="keterangans.{{ $index }}.{{ $keteranganIndex }}.rincianPlate.{{ $rincianIndex }}.waste">
                                                  </div>
                                              </td>
                                              <td>
                                                  <div
                                                      ...
                                                      <button
                                                          ...
                                                          type="button" wire:click="removeRincianPlate({{ $index }}, {{ $keteranganIndex }}, {{ $rincianIndex }})"><i
                                      ...
                                      <div class="form-row">
                                          <div class="col-sm-12 col-md-12">
                                              <div class="form-group">
                                                  ...
                                                  <textarea class="form-control mb-4" placeholder="Catatan" rows="4" wire:model="keterangans.{{ $index }}.{{ $keteranganIndex }}.notes"></textarea>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
