                                ...
                                <td>
                                    ...
                                    @if ($dataInstruction->instruction->group_id)
                                        <button class="btn btn-icon btn-sm btn-info" data-bs-toggle="modal"
                                            ...
                                            wire:click="modalInstructionDetailsGroupReject({{ $dataInstruction->instruction->group_id }})" wire:key="modalInstructionDetailsGroupReject({{ $dataInstruction->instruction->group_id }})">Group-{{ $dataInstruction->instruction->group_id }}</button>
                                    @endif
                                </td>
                                ...
                                <td>
                                    <div class="btn-list">
                                        <button class="btn btn-icon btn-sm btn-dark" data-bs-toggle="modal"
                                            ...
                                            wire:click="modalInstructionDetailsReject({{ $dataInstruction->instruction->id }})" wire:key="modalInstructionDetailsReject({{ $dataInstruction->instruction->id }})"><i
                                                class="fe fe-eye"></i></button>
                                        <a class="btn btn-icon btn-sm btn-primary"
                                            href="{{ route('hitungBahan.editFormHitungBahan', ['instructionId' => $dataInstruction->instruction->id]) }}"><i
