                        ...
                        <ul class="nav panel-tabs">
                            ...
                            <li>
                                <button href="#tab5"
                                    ...
                                    data-bs-toggle="tab" wire:click="changeTab('tab5')" wire:key="tab5">Acc Rab -
                                    {{ $dataCountAccRabSpk }}
                                </button>
                            </li>
                            <li>
                                <button href="#tab6"
                                    class="{{ $activeTab === 'tab6' ? 'active' : '' }} btn btn-success mt-1 mb-1 me-3"
                                    data-bs-toggle="tab" wire:click="changeTab('tab6')" wire:key="tab6">Pengajuan Bahan
                                    -
                                    {{ $dataPengajuanBahan }}
                                </button>
                            </li>
                            <li>
                                <button href="#tab7"
                                    class="{{ $activeTab === 'tab7' ? 'active' : '' }} btn btn-purple mt-1 mb-1 me-3"
                                    data-bs-toggle="tab" wire:click="changeTab('tab7')" wire:key="tab7">Riwayat
                                    Pengajuan Barang
                            ...
                            <li>
                                <button href="#tab8"
                                    ...
                                    data-bs-toggle="tab" wire:click="changeTab('tab8')" wire:key="tab8">All -
                                    {{ $dataCountAllSpk }}
                                </button>
                            </li>
                            <li>
                                <button href="#tab9"
                                    ...
                                    data-bs-toggle="tab" wire:click="changeTab('tab9')" wire:key="tab9">Last Data
                                    Training Program
                                </button>
                            </li>
                        </ul>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                        <h3 class="card-title">Acc RAB</h3>
                                    </div>
                                    <div class="card-body">
                                        @livewire('hitung-bahan.component.acc-rab-dashboard-index')
                                    </div>
                                </div>
                            </div>
                        </div>
