...
@push('scripts')
    ...
    {{-- Layout Bahan Combination --}}
    <script>
        Livewire.on('updateCanvasBahanCombination', (ukuranPanjangLembarCetakLandscape, ukuranLebarLembarCetakLandscape,
            panjangBahan,
