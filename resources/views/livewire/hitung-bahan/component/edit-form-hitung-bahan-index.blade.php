                            ...
                            <div class="card-options">
                                <div class="btn-list">
                                    <button type="button" class="btn btn-sm btn-danger"
                                        wire:click="removeFormSetting({{ $indexSetting }})"><i
                                            class="fe fe-minus"></i>
                                        ...
                                        <div class="example">
                                            ...
                                            <div class="btn-list">
                                                ...
                                                <button type="button" class="btn btn-sm btn-warning"
                                                    onclick="addCanvasSetting({{ $indexSetting }})" id="btn-canvas-setting-{{ $indexSetting }}">Create & Edit
                                                    Canvas</button>
                                    ...
                                    <div class="text-wrap">
                                        <div class="example">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        <label class="form-label">Jarak Tambahan (Vertical &
                                                            Horizontal)
                                                            (cm)</label>
                                                        <div class="row">
                                                            <div class="col-sm">
                                            ...
                                            <div class="example">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <input type="text" autocomplete="off"
                                                                class="form-control" placeholder="Jumlah screen"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <input type="text" autocomplete="off"
                                                                class="form-control" placeholder="Ukuran screen"
                                                        ...
                                                        <table
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <input type="text" autocomplete="off"
                                                                                ...
                                                                                wire:model="keterangans.{{ $keteranganIndex }}.label.0.jenis_ukuran">
                                                                            @error('keterangans.' . $keteranganIndex .
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <input type="text" autocomplete="off"
                                                                                class="form-control"
                                                                                placeholder="Jumlah"
                                                                                wire:model="keterangans.{{ $keteranganIndex }}.label.0.jumlah">
                                                                            @error('keterangans.' . $keteranganIndex .
                                                                                '.label.0.jumlah')
                                                                                <p class="mt-2 text-sm text-danger">
                                                                                    {{ $message }}</p>
                                                                            ...
                                                                            <div class="col-auto">
                                                                                <label
                                                                                    ...
                                                                                    <span
                                                                                        class="custom-switch-indicator custom-switch-indicator-md"></span>
                                                                                    <span
                                                                                        class="custom-switch-description">Ada</span>
                                                                                </label>
                                                                            </div>
                                                                            <div class="col-auto">
                                                                                <label
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <textarea class="form-control mb-4" placeholder="Catatan" rows="2"
                                                                                wire:model="keterangans.{{ $keteranganIndex }}.label.0.catatan_label"></textarea>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <input type="text" autocomplete="off"
                                                                                class="form-control"
                                                                                placeholder="Jenis/Ukuran"
                                                                                wire:model="keterangans.{{ $keteranganIndex }}.label.1.jenis_ukuran">
                                                                            @error('keterangans.' . $keteranganIndex .
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <input type="text" autocomplete="off"
                                                                                class="form-control"
                                                                                placeholder="Jumlah"
                                                                                wire:model="keterangans.{{ $keteranganIndex }}.label.1.jumlah">
                                                                            @error('keterangans.' . $keteranganIndex .
                                                                                '.label.1.jumlah')
                                                                                <p class="mt-2 text-sm text-danger">
                                                                                    {{ $message }}</p>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <textarea class="form-control mb-4" placeholder="Catatan" rows="2"
                                                                                wire:model="keterangans.{{ $keteranganIndex }}.label.1.catatan_label"></textarea>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <input type="text" autocomplete="off"
                                                                                class="form-control"
                                                                                placeholder="Jenis/Ukuran"
                                                                                wire:model="keterangans.{{ $keteranganIndex }}.label.2.jenis_ukuran">
                                                                            @error('keterangans.' . $keteranganIndex .
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <input type="text" autocomplete="off"
                                                                                class="form-control"
                                                                                placeholder="Jumlah"
                                                                                wire:model="keterangans.{{ $keteranganIndex }}.label.2.jumlah">
                                                                            @error('keterangans.' . $keteranganIndex .
                                                                                '.label.2.jumlah')
                                                                                <p class="mt-2 text-sm text-danger">
                                                                                    {{ $message }}</p>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <textarea class="form-control mb-4" placeholder="Catatan" rows="2"
                                                                                wire:model="keterangans.{{ $keteranganIndex }}.label.2.catatan_label"></textarea>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <input type="text" autocomplete="off"
                                                                                class="form-control"
                                                                                placeholder="Jenis/Ukuran"
                                                                                wire:model="keterangans.{{ $keteranganIndex }}.label.3.jenis_ukuran">
                                                                            @error('keterangans.' . $keteranganIndex .
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <input type="text" autocomplete="off"
                                                                                class="form-control"
                                                                                placeholder="Jumlah"
                                                                                wire:model="keterangans.{{ $keteranganIndex }}.label.3.jumlah">
                                                                            @error('keterangans.' . $keteranganIndex .
                                                                                '.label.3.jumlah')
                                                                                <p class="mt-2 text-sm text-danger">
                                                                                    {{ $message }}</p>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <textarea class="form-control mb-4" placeholder="Catatan" rows="2"
                                                                                wire:model="keterangans.{{ $keteranganIndex }}.label.3.catatan_label"></textarea>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-options">
                                <div class="btn-list">
                                    <button type="button" class="btn btn-sm btn-danger"
                                        wire:click="removeFormBahan({{ $indexBahan }})"><i
                                            class="fe fe-minus"></i>
                                        ...
                                        <div class="example">
                                            ...
                                            <div class="btn-list">
                                                ...
                                                <button type="button"
                                                    ...
                                                    style="display: none;">Export</button>
                                                <button type="button" class="btn btn-sm btn-warning"
                                                    onclick="addCanvasBahan({{ $indexBahan }})" id="btn-canvas-bahan-{{ $indexBahan }}">Create & Edit
                                                    Canvas</button>
                                    ...
                                    <ul>
                                        @if ($bahan['layout_custom_file_name'])
                                            <li class="mb-3">
                                                ...
                                                <div class="expanel expanel-default">
                                                    <div class="expanel-body">
                                                        <a href="{{ asset(Storage::url($bahan['layout_custom_path'] . '/' . $bahan['layout_custom_file_name'])) }}"
                                                            download>{{ $bahan['layout_custom_file_name'] }}</a>
                                                    </div>
                                                </div>
                                            </li>
                                        @else
                                                    ...
                                                    <tbody>
                                                        @if ($selectedInstructionParent)
                                                            <tr>
                                                                ...
                                                                <td>{{ $selectedInstructionParent->price ?? '-' }}
                                                                </td>
                                                            </tr>
                                                        @endif
