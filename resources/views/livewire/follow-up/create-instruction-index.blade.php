                ...
                <div class="form-group">
                    <div wire:ignore>
                        <div class="form-group">
                            ...
                            <select class="form-control" data-clear data-pharaonic="select2" data-component-id="{{ $this->id }}" data-placeholder="Select Customer" wire:model.defer="customer" id="customer">
            ...
            <div class="col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <label class="custom-switch form-switch me-5">
                                <input type="checkbox" wire:model.defer="sub_spk" class="custom-switch-input @error('sub_spk') is-invalid @enderror" value="sub">
                                <span class="custom-switch-indicator custom-switch-indicator-md"></span>
            ...
            <div class="col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <label class="custom-switch form-switch me-5">
                                <input type="checkbox" wire:model.defer="spk_fsc" class="custom-switch-input @error('spk_fsc') is-invalid @enderror" value="fsc">
                                <span class="custom-switch-indicator custom-switch-indicator-md"></span>
