<div>
                                    ...
                                    <div class="btn-list">
                                        @if ($dataInstruction->instruction->spk_type == 'sample')
                                            <button class="btn btn-icon btn-sm btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#openModalRevisiSampleAcc"
                                                wire:click="modalInstructionDetailsRevisiSampleAcc({{ $dataInstruction->instruction->id }})"
                                                wire:key="modalInstructionDetailsRevisiSampleAcc({{ $dataInstruction->instruction->id }})"><i
    ...
    <!-- Modal Revisi Sample-->
    <div wire:ignore.self class="modal fade" id="openModalRevisiSampleAcc" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Detail Instruction</h5>
...
@push('scripts')
    <script>
        window.addEventListener('close-modal-revisi-sample-acc', event => {
            $('#openModalRevisiSampleAcc').modal('hide');
        });
    </script>
@endpush
