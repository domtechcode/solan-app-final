                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($dataInstruction->instruction->group_id)
                                        <button class="btn btn-icon btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#openModalGroupAll" wire:click="modalInstructionDetailsGroupAll({{ $dataInstruction->instruction->group_id }})">Group-{{ $dataInstruction->instruction->group_id }}</button>
                                    @endif
                                </td>
                                ...
                                <td>
                                    <div class="btn-list">         
                                        <button class="btn btn-icon btn-sm btn-dark" data-bs-toggle="modal" data-bs-target="#openModalAll" wire:click="modalInstructionDetailsAll({{ $dataInstruction->instruction->id }})"><i class="fe fe-eye"></i></button>
                                    </div>
                                </td>
                            </tr>
                        @empty
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-icon btn-primary" wire:click="deleteSpk({{ $instructionSelectedId }})"><i class="fe fe-trash"></i> Delete</button>
