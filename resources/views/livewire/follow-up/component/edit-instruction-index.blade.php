                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="date" wire:model="shipping_date_change"
                                ...
                                <div class="form-group">
                                    <div wire:ignore>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" data-clear data-pharaonic="select2"
                                                data-component-id="{{ $this->id }}"
                                                wire:model="spk_layout_number" id="spk_layout_number"
                                ...
                                <div class="form-group">
                                    <div wire:ignore>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" data-clear data-pharaonic="select2"
                                                data-component-id="{{ $this->id }}"
                                                wire:model="spk_sample_number" id="spk_sample_number"
                                                data-placeholder="Choose one">
                                                <option value="">Choose one</option>
