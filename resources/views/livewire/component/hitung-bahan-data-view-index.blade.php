                        ...
                        <div class="table-responsive">
                            <table class="table border text-nowrap text-md-nowrap table-bordered table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="8"><strong>Total Qty</strong></td>
                                        <td colspan="4"><strong>{{ currency_idr($total_qty) }}</strong></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="text-wrap">
                                        <div class="example">
                                            <h3 class="card-title">Layout Setting - {{ $indexSetting }}</h3>
                                            <img class="img-responsive" src="{{ $layoutSettings[$indexSetting]['dataURL'] }}" style="width: 70%;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm">
                                                                <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutSettings.{{ $indexSetting }}.panjang_barang_jadi" disabled>
                                                            ...
                                                            <div class="col-sm">
                                                                <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutSettings.{{ $indexSetting }}.lebar_barang_jadi" disabled>
                                                                @error('layoutSettings.' . $indexSetting .
                                                                    '.lebar_barang_jadi')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm">
                                                                <input type="text" autocomplete="off"
                                                                    class="form-control" placeholder="Panjang"
                                                                    wire:model="layoutSettings.{{ $indexSetting }}.panjang_bahan_cetak" disabled>
                                                                @error('layoutSettings.' . $indexSetting .
                                                                    '.panjang_bahan_cetak')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            ...
                                                            <div class="col-sm">
                                                                <input type="text" autocomplete="off"
                                                                    class="form-control" placeholder="Lebar"
                                                                    wire:model="layoutSettings.{{ $indexSetting }}.lebar_bahan_cetak" disabled>
                                                                @error('layoutSettings.' . $indexSetting .
                                                                    '.lebar_bahan_cetak')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutSettings.{{ $indexSetting }}.panjang_naik" disabled>
                                                                @error('layoutSettings.' . $indexSetting .
                                                                    '.panjang_naik')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutSettings.{{ $indexSetting }}.lebar_naik" disabled>
                                                                @error('layoutSettings.' . $indexSetting .
                                                                    '.lebar_naik')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutSettings.{{ $indexSetting }}.jarak_panjang" disabled>
                                                                @error('layoutSettings.' . $indexSetting .
                                                                    '.jarak_panjang')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutSettings.{{ $indexSetting }}.jarak_lebar" disabled>
                                                                @error('layoutSettings.' . $indexSetting .
                                                                    '.jarak_lebar')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm">
                                                                <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutSettings.{{ $indexSetting }}.sisi_atas" disabled>
                                                                @error('layoutSettings.' . $indexSetting .
                                                                    '.sisi_atas')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            ...
                                                            <div class="col-sm">
                                                                <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutSettings.{{ $indexSetting }}.sisi_bawah" disabled>
                                                                @error('layoutSettings.' . $indexSetting .
                                                                    '.sisi_bawah')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm">
                                                                <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutSettings.{{ $indexSetting }}.sisi_kiri" disabled>
                                                                @error('layoutSettings.' . $indexSetting .
                                                                    '.sisi_kiri')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            ...
                                                            <div class="col-sm">
                                                                <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutSettings.{{ $indexSetting }}.sisi_kanan" disabled>
                                                                @error('layoutSettings.' . $indexSetting .
                                                                    '.sisi_kanan')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm">
                                                                <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutSettings.{{ $indexSetting }}.jarak_tambahan_vertical" disabled>
                                                                @error('layoutSettings.' . $indexSetting .
                                                            ...
                                                            <div class="col-sm">
                                                                <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutSettings.{{ $indexSetting }}.jarak_tambahan_horizontal" disabled>
                                                                @error('layoutSettings.' . $indexSetting .
                                                ...
                                                <div class="col-md-2">
                                                    <label class="custom-switch form-switch me-5">
                                                        <input type="checkbox"
                                                            ...
                                                            class="custom-switch-input" value="baru" {{ data_get($keterangans, $keteranganIndex . '.plate.0.state_plate') === 'baru' ? 'checked' : '' }} disabled>
                                                        <span
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <input type="text" autocomplete="off" class="form-control"
                                                            ...
                                                            {{ empty(data_get($keterangans, $keteranganIndex . '.plate.0.state_plate')) ? 'disabled' : '' }} disabled>
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <input type="text" autocomplete="off" class="form-control"
                                                            ...
                                                            {{ empty(data_get($keterangans, $keteranganIndex . '.plate.1.state_plate')) ? 'disabled' : '' }} disabled>
                                                        @error('keterangans.' . $keteranganIndex .
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <input type="text" autocomplete="off" class="form-control"
                                                            ...
                                                            {{ empty(data_get($keterangans, $keteranganIndex . '.plate.2.state_plate')) ? 'disabled' : '' }} disabled>
                                                        @error('keterangans.' . $keteranganIndex .
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <input type="text" autocomplete="off" class="form-control"
                                                            ...
                                                            {{ empty(data_get($keterangans, $keteranganIndex . '.screen.0.state_screen')) ? 'disabled' : '' }} disabled>
                                                        @error('keterangans.' . $keteranganIndex .
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <input type="text" autocomplete="off" class="form-control"
                                                            ...
                                                            {{ empty(data_get($keterangans, $keteranganIndex . '.screen.1.state_screen')) ? 'disabled' : '' }} disabled>
                                                        @error('keterangans.' . $keteranganIndex .
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <input type="text" autocomplete="off" class="form-control"
                                                            ...
                                                            {{ empty(data_get($keterangans, $keteranganIndex . '.screen.2.state_screen')) ? 'disabled' : '' }} disabled>
                                                        @error('keterangans.' . $keteranganIndex .
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text" autocomplete="off" class="form-control"
                                                            ...
                                                            {{ empty(data_get($keterangans, $keteranganIndex . '.pond.0.state_pisau')) ? 'disabled' : '' }} disabled>
                                                        @error('keterangans.' . $keteranganIndex .
                                                            '.pond.0.jumlah_pisau')
                                                            <p class="mt-2 text-sm text-danger">{{ $message }}</p>
                                                        @enderror
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text" autocomplete="off" class="form-control"
                                                            ...
                                                            {{ empty(data_get($keterangans, $keteranganIndex . '.pond.1.state_pisau')) ? 'disabled' : '' }} disabled>
                                                        @error('keterangans.' . $keteranganIndex .
                                                            '.pond.1.jumlah_pisau')
                                                            <p class="mt-2 text-sm text-danger">{{ $message }}</p>
                                                        @enderror
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="text" autocomplete="off" class="form-control"
                                                            ...
                                                            {{ empty(data_get($keterangans, $keteranganIndex . '.pond.2.state_pisau')) ? 'disabled' : '' }} disabled>
                                                        @error('keterangans.' . $keteranganIndex .
                                                            '.pond.2.jumlah_pisau')
                                                            <p class="mt-2 text-sm text-danger">{{ $message }}</p>
                                                        @enderror
                                            ...
                                            <tbody>
                                                @forelse ($keterangan['fileRincian'] as $key => $file)
                                                    <tr wire:key="file-{{ $file['file_name'] }}">
                                                        <td><a href="{{ asset(Storage::url($file['file_path'].'/'.$file['file_name'])) }}" download>{{ $file['file_name'] }}</a></td>
                                                    </tr>
                                                @empty
                                                    <tr>
                                                                ...
                                                                <td>
                                                                    <div class="form-group">
                                                                        <input type="text" autocomplete="off"
                                                                            ...
                                                                            wire:model="keterangans.{{ $keteranganIndex }}.rincianPlate.{{ $rincianIndexPlate }}.plate" disabled>
                                                                        @error('keterangans.' . $keteranganIndex .
                                                                ...
                                                                <td>
                                                                    <div class="form-group">
                                                                        <input type="text" autocomplete="off"
                                                                            ...
                                                                            wire:model="keterangans.{{ $keteranganIndex }}.rincianPlate.{{ $rincianIndexPlate }}.jumlah_lembar_cetak" disabled>
                                                                        @error('keterangans.' . $keteranganIndex .
                                                                ...
                                                                <td>
                                                                    <div class="form-group">
                                                                        <input type="text" autocomplete="off"
                                                                            ...
                                                                            wire:model="keterangans.{{ $keteranganIndex }}.rincianPlate.{{ $rincianIndexPlate }}.waste" disabled>
                                                                        @error('keterangans.' . $keteranganIndex .
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="form-group">
                                                                        <input type="text" autocomplete="off"
                                                                            ...
                                                                            wire:model="keterangans.{{ $keteranganIndex }}.rincianScreen.{{ $rincianIndexScreen }}.screen" disabled>
                                                                        @error('keterangans.' . $keteranganIndex .
                                                                ...
                                                                <td>
                                                                    <div class="form-group">
                                                                        <input type="text" autocomplete="off"
                                                                            class="form-control"
                                                                            placeholder="Jumlah Lembar Cetak"
                                                                            wire:model="keterangans.{{ $keteranganIndex }}.rincianScreen.{{ $rincianIndexScreen }}.jumlah_lembar_cetak" disabled>
                                                                        @error('keterangans.' . $keteranganIndex .
                                                                ...
                                                                <td>
                                                                    <div class="form-group">
                                                                        <input type="text" autocomplete="off"
                                                                            class="form-control" placeholder="Waste"
                                                                            wire:model="keterangans.{{ $keteranganIndex }}.rincianScreen.{{ $rincianIndexScreen }}.waste" disabled>
                                                                        @error('keterangans.' . $keteranganIndex .
                                ...
                                <div class="col-lg-12">
                                    <div class="text-wrap">
                                        <div class="example">
                                            ...
                                            <img class="img-responsive" src="{{ asset(Storage::url($bahan['layout_custom_path'].'/'.$bahan['layout_custom_file_name'])) }}">
                                            @else
                                            <img class="img-responsive" src="{{ $layoutBahans[$indexBahan]['dataURL'] }}" style="width: 70%;">
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm">
                                                                <input type="text" autocomplete="off"
                                                                    class="form-control" placeholder="Panjang"
                                                                    wire:model="layoutBahans.{{ $indexBahan }}.panjang_plano" disabled>
                                                            ...
                                                            <div class="col-sm">
                                                                <input type="text" autocomplete="off"
                                                                    class="form-control" placeholder="Lebar"
                                                                    wire:model="layoutBahans.{{ $indexBahan }}.lebar_plano" disabled>
                                                                @error('layoutBahans.' . $indexBahan .
                                                                    '.lebar_plano')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm">
                                                                <input type="text" autocomplete="off"
                                                                    class="form-control" placeholder="Panjang"
                                                                    wire:model="layoutBahans.{{ $indexBahan }}.panjang_bahan_cetak" disabled>
                                                                @error('layoutBahans.' . $indexBahan .
                                                                    '.panjang_bahan_cetak')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            ...
                                                            <div class="col-sm">
                                                                <input type="text" autocomplete="off"
                                                                    class="form-control" placeholder="Lebar"
                                                                    wire:model="layoutBahans.{{ $indexBahan }}.lebar_bahan_cetak" disabled>
                                                                @error('layoutBahans.' . $indexBahan .
                                                                    '.lebar_bahan_cetak')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutBahans.{{ $indexBahan }}.jenis_bahan" disabled>
                                                                @error('layoutBahans.' . $indexBahan .
                                                                    '.jenis_bahan')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutBahans.{{ $indexBahan }}.gramasi" disabled>
                                                                @error('layoutBahans.' . $indexBahan .
                                                                    '.gramasi')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutBahans.{{ $indexBahan }}.one_plano" disabled>
                                                                @error('layoutBahans.' . $indexBahan .
                                                                    '.one_plano')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutBahans.{{ $indexBahan }}.sumber_bahan" disabled>
                                                                @error('layoutBahans.' . $indexBahan .
                                                                    '.sumber_bahan')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutBahans.{{ $indexBahan }}.merk_bahan" disabled>
                                                                @error('layoutBahans.' . $indexBahan .
                                                                    '.merk_bahan')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutBahans.{{ $indexBahan }}.supplier" disabled>
                                                                @error('layoutBahans.' . $indexBahan .
                                                                    '.supplier')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model.defer="layoutBahans.{{ $indexBahan }}.jumlah_lembar_cetak" wire:change="calculateTotalLembarCetak({{ $indexBahan }})" disabled>
                                                                @error('layoutBahans.' . $indexBahan .
                                                                    '.jumlah_lembar_cetak')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model.defer="layoutBahans.{{ $indexBahan }}.jumlah_incit" wire:change="calculateTotalLembarCetak({{ $indexBahan }})" disabled>
                                                                @error('layoutBahans.' . $indexBahan .
                                                                    '.jumlah_incit')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model.defer="layoutBahans.{{ $indexBahan }}.total_lembar_cetak" disabled>
                                                                @error('layoutBahans.' . $indexBahan .
                                                                    '.total_lembar_cetak')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutBahans.{{ $indexBahan }}.harga_bahan" type-currency="IDR" disabled>
                                                                @error('layoutBahans.' . $indexBahan .
                                                                    '.harga_bahan')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                ...
                                                <div class="col-sm-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off"
                                                                    ...
                                                                    wire:model="layoutBahans.{{ $indexBahan }}.jumlah_bahan" disabled>
                                                                @error('layoutBahans.' . $indexBahan .
                                                                    '.jumlah_bahan')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm">
                                                                <input type="text" autocomplete="off"
                                                                    class="form-control" placeholder="Panjang"
                                                                    wire:model="layoutBahans.{{ $indexBahan }}.panjang_sisa_bahan" disabled>
                                                                @error('layoutBahans.' . $indexBahan .
                                                                    '.panjang_sisa_bahan')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
                                                            ...
                                                            <div class="col-sm">
                                                                <input type="text" autocomplete="off"
                                                                    class="form-control" placeholder="Lebar"
                                                                    wire:model="layoutBahans.{{ $indexBahan }}.lebar_sisa_bahan" disabled>
                                                                @error('layoutBahans.' . $indexBahan .
                                                                    '.lebar_sisa_bahan')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                @enderror
