            ...
            <div class="card">
                ...
                <div class="card-body">
                            ...
                            <table class="table border text-nowrap text-md-nowrap table-bordered table-hover mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-bottom-0">Nama Anggota</th>
                                        <th class="border-bottom-0">Hasil Per Anggota</th>
                                        <th class="border-bottom-0">Hasil Akhir</th>
                                        <th class="border-bottom-0">Jumlah Barang Gagal</th>
                                        <th class="border-bottom-0">Satuan</th>
                                        <th class="border-bottom-0">Tanggal</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @forelse ($sortirData as $data)
                                        <tr>
                                            <td>{{ $data['instruction']['spk_number'] }}</td>
                                            <td>{{ $data['nama_anggota'] }}</td>
                                            <td>{{ $data['hasil_per_anggota'] }}</td>
                                            <td>{{ $data['hasil_akhir'] }}</td>
                                            <td>{{ $data['jumlah_barang_gagal'] }}</td>
                                            <td>{{ $data['satuan'] }}</td>
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="expanel expanel-default">
                                <div class="expanel-body">
                                    <div class="row">
                                        <div class="col-sm-3 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <select wire:model="no_spk" id="no_spk" class="form-control form-select"
                                                        data-bs-placeholder="Pilih SPK">
                                                        <option label="-- Pilih SPK --"></option>
                                                        @foreach ($instructionData as $data)
                                                        <option value="{{ $data['id'] }}">{{ $data['spk_number'] }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                @error('no_spk')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" wire:model="jumlah_barang_gagal" id="jumlah_barang_gagal" class="form-control"
                                                        autocomplete="off" placeholder="Jumlah Barang Gagal">
                                                </div>
                                    ...
                                    <button type="button" style="display: none;" class="btn btn-info mt-4 mb-0 submitBtn" wire:click="update" wire:ignore.self>Update & Split</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <button type="button" style="display: none;" class="btn btn-success mt-4 mb-0 submitBtn"
                        wire:click="save" wire:ignore.self>Sortir Selesai</button>
                </div>
            </div>
        </div>
    </div>
