                    ...
                    <div class="row">
                                    ...
                                    @foreach($anggota as $index => $data)
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <select wire:model="anggota.{{ $index }}.nama" class="form-control form-select" data-bs-placeholder="Pilih Nama Anggota" readonly>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <input type="text" wire:model="anggota.{{ $index }}.hasil" class="form-control" autocomplete="off" placeholder="Hasil" readonly>
                                                    </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" wire:model="hasil_akhir" id="hasil_akhir" class="form-control" autocomplete="off" placeholder="Hasil Akhir" readonly>
                                </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" wire:model="jumlah_barang_gagal" id="jumlah_barang_gagal" class="form-control" autocomplete="off" placeholder="Jumlah Barang Gagal" readonly>
                                </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" wire:model="jumlah_stock" id="jumlah_stock" class="form-control" autocomplete="off" placeholder="Jumlah Stock" readonly>
                                </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" wire:model="lokasi_stock" id="lokasi_stock" class="form-control" autocomplete="off" placeholder="Lokasi Stock" readonly>
                                </div>
