<div>
    ...
    <div class="row">
        <div class="col">
                <select id="" name="" class="form-control form-select w-auto" wire:model="paginateRiwayatPengajuanBarangPersonal">
        ...
        <div class="col d-flex justify-content-end">
            <input type="text" class="form-control w-auto" placeholder="Search" wire:model="searchRiwayatPengajuanBarangPersonal">
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-md-12">
                ...
                <table class="table border text-nowrap text-md-nowrap table-bordered table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-list">         
                                    <button class="btn btn-icon btn-sm btn-dark" data-bs-toggle="modal" data-bs-target="#modalRiwayatPengajuanBarangPersonal" wire:key="modalRiwayatPengajuanBarangPersonal" wire:click="modalRiwayatPengajuanBarangPersonal({{ $itemPengajuanBarangPersonal->id }})"><i class="fe fe-eye"></i></button>
                                </div>
                            </td>
                        </tr>
                        @empty
