                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div wire:ignore>
                                                    ...
                                                    <select class="form-control" id="groupCurrentIdSelected" data-clear data-pharaonic="select2" data-component-id="{{ $this->id }}" data-placeholder="Select Group" wire:model.defer="groupCurrentIdSelected">
                                            ...
                                            @error('groupCurrentIdSelected') <div><span class="text-danger">{{ $message }}</span></div> @enderror
                                        </div>
                                    </div>
