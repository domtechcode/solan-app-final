    ...
    <div class="row">
        <div class="col">
            <select id="" name="" class="form-control form-select w-auto"
                wire:model="paginatePengajuanStockBarangPersonal">
        ...
        <div class="col d-flex justify-content-end">
            <input type="text" class="form-control w-auto" placeholder="Search"
                wire:model="searchPengajuanStockBarangPersonal">
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table border text-nowrap text-md-nowrap table-bordered table-hover mb-0">
                    ...
                    <tbody>
                        @forelse ($pengajuanStockBarangPersonal as $key => $itemPengajuanBarangSpk)
                            <tr>
                                <td>{{ $key + 1 }}</td>
                                <td>
                                ...
                                <td>
                                    <div class="btn-list">
                                        <button class="btn btn-icon btn-sm btn-dark" data-bs-toggle="modal"
                                            data-bs-target="#modalPengajuanStockBarangPersonal"
                                            wire:click="modalPengajuanStockBarangPersonal({{ $itemPengajuanBarangSpk->id }})"
                                            wire:key="modalPengajuanStockBarangPersonal({{ $itemPengajuanBarangSpk->id }})"><i
        ...
        <div class="col d-flex justify-content-end mt-3">
            {{ $pengajuanStockBarangPersonal->links() }}
        </div>
    </div>

    <!-- Modal General-->
    <div wire:ignore.self class="modal fade" id="modalPengajuanStockBarangPersonal" tabindex="-1" role="dialog">
...
@push('scripts')
    <script>
        window.addEventListener('close-modal-pengajuan-stock-barang-personal', event => {
            $('#modalPengajuanStockBarangPersonal').modal('hide');
        });
    </script>
@endpush
