<div>
    ...
    <div class="row">
        <div class="col">
            <select id="" name="" class="form-control form-select w-auto" wire:model="paginatePengajuanProcessBarangPersonal">
        ...
        <div class="col d-flex justify-content-end">
            <input type="text" class="form-control w-auto" placeholder="Search" wire:model="searchPengajuanProcessBarangPersonal">
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-md-12">
        ...
        <div class="col d-flex justify-content-end mt-3">
            {{ $pengajuanProcessBarangPersonal->links() }}
        </div>
    </div>

    <!-- Modal General-->
    <div wire:ignore.self class="modal fade" id="modalPengajuanProcessBarangPersonal" tabindex="-1" role="dialog">
...
@push('scripts')
    <script>
        window.addEventListener('close-modal-pengajuan-process-barang-personal', event => {
            $('#modalPengajuanProcessBarangPersonal').modal('hide');
        });
    </script>
@endpush
