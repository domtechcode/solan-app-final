    ...
    <div class="row">
        <div class="col">
            <select id="" name="" class="form-control form-select w-auto"
                wire:model="paginatePengajuanStockBarangSpk">
        ...
        <div class="col d-flex justify-content-end">
            <input type="text" class="form-control w-auto" placeholder="Search"
                wire:model="searchPengajuanStockBarangSpk">
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table border text-nowrap text-md-nowrap table-bordered table-hover mb-0">
                    ...
                    <tbody>
                        @forelse ($pengajuanStockBarangSpk as $key => $itemPengajuanBarangSpk)
                            <tr>
                                <td>{{ $key + 1 }}</td>
                                <td>
                                ...
                                <td>
                                    <div class="btn-list">
                                        <button class="btn btn-icon btn-sm btn-dark" data-bs-toggle="modal"
                                            data-bs-target="#modalPengajuanStockBarangSpk"
                                            wire:click="modalPengajuanStockBarangSpk({{ $itemPengajuanBarangSpk->id }}, {{ $itemPengajuanBarangSpk->instruction_id }})"
                                            wire:key="modalPengajuanStockBarangSpk({{ $itemPengajuanBarangSpk->id }}, {{ $itemPengajuanBarangSpk->instruction_id }})"><i
        ...
        <div class="col d-flex justify-content-end mt-3">
            {{ $pengajuanStockBarangSpk->links() }}
        </div>
    </div>

    <!-- Modal General-->
    <div wire:ignore.self class="modal fade" id="modalPengajuanStockBarangSpk" tabindex="-1" role="dialog">
...
@push('scripts')
    <script>
        window.addEventListener('close-modal-pengajuan-stock-barang-spk', event => {
            $('#modalPengajuanStockBarangSpk').modal('hide');
        });
    </script>
@endpush
