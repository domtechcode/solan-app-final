    ...
    <div class="row">
        <div class="col">
            <select id="" name="" class="form-control form-select w-auto"
                wire:model="paginatePengajuanApprovedBarangPersonal">
        ...
        <div class="col d-flex justify-content-end">
            <input type="text" class="form-control w-auto" placeholder="Search"
                wire:model="searchPengajuanApprovedBarangPersonal">
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-md-12">
                                ...
                                <td>
                                    <div class="btn-list">
                                        <button class="btn btn-icon btn-sm btn-dark" data-bs-toggle="modal"
                                            data-bs-target="#modalPengajuanApprovedBarangPersonal"
                                            wire:click="modalPengajuanApprovedBarangPersonal({{ $itemPengajuanBarangSpk->id }})"
                                            wire:key="modalPengajuanApprovedBarangPersonal({{ $itemPengajuanBarangSpk->id }})"><i
        ...
        <div class="col d-flex justify-content-end mt-3">
            {{ $pengajuanApprovedBarangPersonal->links() }}
        </div>
    </div>

    <!-- Modal General-->
    <div wire:ignore.self class="modal fade" id="modalPengajuanApprovedBarangPersonal" tabindex="-1" role="dialog">
...
@push('scripts')
    <script>
        window.addEventListener('close-modal-pengajuan-approved-barang-personal', event => {
            $('#modalPengajuanApprovedBarangPersonal').modal('hide');
        });
    </script>
@endpush
