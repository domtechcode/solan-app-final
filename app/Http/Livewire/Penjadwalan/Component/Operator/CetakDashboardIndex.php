...
class CetakDashboardIndex extends Component
{
    use WithPagination;
    protected $paginationTheme = 'bootstrap';
    protected $updatesQueryString = ['search'];

    public $paginateCetak = 10;
    public $searchCetak = '';
    ...
    public function updatingSearchCetak()
    {
        $this->resetPage();
    }
    ...
    {
        $this->searchCetak = request()->query('search', $this->searchCetak);
    }
    ...
    public function modalInstructionDetailsCetak($instructionId)
    {
    ...
    public function modalInstructionDetailsGroupCetak($groupId)
    {
