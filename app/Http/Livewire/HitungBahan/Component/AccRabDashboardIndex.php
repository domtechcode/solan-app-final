...
class AccRabDashboardIndex extends Component
{
    use WithPagination;
    protected $paginationTheme = 'bootstrap';
    protected $updatesQueryString = ['search'];

    public $paginateAccRab = 10;
    public $searchAccRab = '';
    ...
    {
        $this->searchAccRab = request()->query('search', $this->searchAccRab);
    }

    public function updatingSearchAccRab()
    {
        $this->resetPage();
    }
    ...
    {
        $dataAccRab = WorkStep::whereNotIn('spk_status', ['Hold', 'Cancel', 'Hold RAB', 'Hold Waiting Qty QC', 'Hold Qc', 'Failed Waiting Qty QC', 'Deleted', 'Acc', 'Training Program'])
            ...
            ->paginate($this->paginateAccRab);

        return view('livewire.hitung-bahan.component.acc-rab-dashboard-index', ['instructionsAccRab' => $dataAccRab])
            ->extends('layouts.app')
            ->section('content')
            ->layoutData(['title' => 'Dashboard']);
    }

    public function modalInstructionDetailsAccRab($instructionId)
    {
    ...
    public function modalInstructionDetailsGroupAccRab($groupId)
    {
