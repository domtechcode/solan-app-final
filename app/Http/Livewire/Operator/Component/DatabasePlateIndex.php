...
class DatabasePlateIndex extends Component
{
    use WithPagination;
    ...
    {
        $dataNewSpk = WarnaPlate::where('kondisi', '!=', null)
            ->paginate($this->paginateNewSpk);
        

        return view('livewire.operator.component.database-plate-index', ['instructionsNewSpk' => $dataNewSpk])
            ->extends('layouts.app')
            ->section('content')
