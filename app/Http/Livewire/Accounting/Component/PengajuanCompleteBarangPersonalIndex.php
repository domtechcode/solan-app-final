...
class PengajuanCompleteBarangPersonalIndex extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.accounting.component.pengajuan-complete-barang-personal-index', ['pengajuanCompleteBarangPersonal' => $dataPengajuanCompleteBarangPersonal])
            ->extends('layouts.app')
            ->section('content')
