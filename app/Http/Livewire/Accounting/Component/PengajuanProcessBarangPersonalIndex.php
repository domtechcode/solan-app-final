...
class PengajuanProcessBarangPersonalIndex extends Component
{
    ...
    {
        $dataPengajuanProcessBarangPersonal = PengajuanBarangPersonal::whereIn('status_id', [11])
        ...
        return view('livewire.accounting.component.pengajuan-process-barang-personal-index', ['pengajuanProcessBarangPersonal' => $dataPengajuanProcessBarangPersonal])
            ->extends('layouts.app')
            ->section('content')
