...
class HitungBahanAllDataRabGeneralIndex extends Component
{
    use WithFileUploads;
    public $filerincian = [];
    ...
    public function mount($instructionId, $workStepId)
    {
        ...
        $this->dataRab = FormRab::where('instruction_id', $instructionId)->get();
    ...
    {
        return view('livewire.component.hitung-bahan-all-data-rab-general-index')->extends('layouts.app')
        ->section('content')
