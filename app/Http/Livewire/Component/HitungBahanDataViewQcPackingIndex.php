...
class HitungBahanDataViewQcPackingIndex extends Component
{
    use WithFileUploads;
    public $filerincian = [];
    ...
    public function mount($instructionId, $workStepId)
    {
        ...
        $this->note = Catatan::where('instruction_id', $instructionId)
            ...
            ->where('tujuan', $dataWorkStep->work_step_list_id)
            ->get();
        $this->notereject = Catatan::where('instruction_id', $instructionId)
            ->where('kategori', 'reject')
            ->where('tujuan', $dataWorkStep->work_step_list_id)
            ->get();
        $this->noterevisi = Catatan::where('instruction_id', $instructionId)
        ...
        $this->fileCheckerData = Files::where('instruction_id', $instructionId)
    ...
    {
        return view('livewire.component.hitung-bahan-data-view-qc-packing-index')
            ->extends('layouts.app')
            ->section('content')
