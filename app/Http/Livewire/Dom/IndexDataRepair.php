...
class IndexDataRepair extends Component
{
    ...
    public function render()
    {
        ...
        // $dataFormCetak = FormCetak::pluck('instruction_id');
        // $dataFormCetak = FormCetak::with('rincianPlate')->get();
        // foreach ($dataFormCetak as $key => $index) {
        //     $data = [
        //         'instruction_id' => $index['instruction_id'],
        //         'user_id' => $index['user_id'],
        //         'step' => $index['step'],
        ...
        //         'jumlah_lembar_cetak' => $index['rincianPlate'] ? $index['rincianPlate']['jumlah_lembar_cetak'] : null,
        //         'waste' => $index['rincianPlate'] ? $index['rincianPlate']['waste'] : null,
        //         'hasil_akhir_lembar_cetak' => $index['hasil_akhir_lembar_cetak'],
        //         'hasil_akhir_lembar_cetak_plate' => $index['hasil_akhir_lembar_cetak_plate'],
        //     ];
        ...
        // $deleteCetak = FormCetak::query()->delete();

        // $id = 1;
        // foreach ($FormCetak as $key => $index) {
        //     $create = FormCetak::create([
        //         'id' => $id,
        //         'instruction_id' => $index['instruction_id'],
        //         'user_id' => $index['user_id'],
        //         'step' => $index['step'],
        ...
        // $workStep = WorkStep::whereIn('instruction_id', $dataFormCetak)
        //     ->where('work_step_list_id', 10)
        //     ->get();
        // foreach ($workStep as $data) {
        //     $work = [
        //         'instruction_id' => $data['instruction_id'],
        ...
        // foreach ($dataWorkStep as $data) {
        //     $updateFormPotongJadi = FormCetak::where('instruction_id', $data['instruction_id'])->update([
        //         'user_id' => $data['user_id'],
        //         'step' => $data['step'],
        //     ]);
        // }
